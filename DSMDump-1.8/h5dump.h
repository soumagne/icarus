...
H5DUMP_EXPORT int H5dump_xml(std::ostringstream &, const char *filename);

// DSM specific functions
H5DUMP_EXPORT int H5dump_dsm(void *dsmBuffer);
H5DUMP_EXPORT int H5dump_dsm_light(void *dsmBuffer);
H5DUMP_EXPORT int H5dump_dsm_xml(std::ostringstream &, void *dsmBuffer);
