/*=========================================================================
  ...
  Module:    $RCSfile: vtkXdmfReader3.h,v $
  Language:  C++
...
=========================================================================*/
// .NAME vtkXdmfReader3 - read eXtensible Data Model and Format files
// .SECTION Description
// vtkXdmfReader3 is a source object that reads XDMF data.
...
#ifndef __vtkXdmfReader3_h
#define __vtkXdmfReader3_h
...
class VTK_EXPORT vtkXdmfReader3 : public vtkDataReader
{
public:
  static vtkXdmfReader3* New();
  vtkTypeRevisionMacro(vtkXdmfReader3, vtkDataReader);
...
protected:
  ...
  int  UpdateDomains();
  void UpdateRootGrid();
  void UpdateGrids(vtkXdmfReader3Grid *parent, void *ParentNode);
  void FindTimeValues();
  void FindAllTimeValues(vtkXdmfReader3Grid *ptr);
  void AssignTimeIndex(vtkXdmfReader3Grid *ptr);
  ...
  //
  vtkXdmfReader3Internal* Internals;
  XdmfDOM         *DOM;
...
private:
  vtkXdmfReader3(const vtkXdmfReader3&); // Not implemented
  void operator=(const vtkXdmfReader3&); // Not implemented
};

#endif //__vtkXdmfReader3_h
